...
class TreePrinter:
    ...
    @addToClass(classes.Assignment)  # works fine
    def printTree(self, indent=0):
    ...
    @addToClass(classes.Int)
    def printTree(self, indent=0):
        return indent * indent_char + str(self.value) + "\n"

    @addToClass(classes.Float)
    def printTree(self, indent=0):
        return indent * indent_char + str(self.value) + "\n"


    @addToClass(classes.String)
    def printTree(self, indent=0):
        return indent * indent_char + str(self.value) + "\n"
